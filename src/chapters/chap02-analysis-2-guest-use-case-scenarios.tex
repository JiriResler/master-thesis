...
\noindent \textbf{UC3: Use case: Look up online what a restaurant offers today}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Guest \\
    ...
    \hline
    Precondition & The guest has added the restaurant to the list of their favorite restaurants. \\
    \hline
    Postcondition & The guest sees the restaurant's menu. \\
    \hline
    Scenario     &
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        \item The guest logs in to the application.
        \item The application displays an overview of what the guest's favorite restaurants currently serve. \textbf{A1}
        \item The guest clicks on the restaurant whose menu they wish to see. \textbf{A2}
        \item The application lists all menus of the chosen restaurant. 
        \item The guest selects one of the menus.
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{description}[nosep,after=\strut] 
        ...
        \item [A2:] The restaurant has no valid menu published at the moment. The application displays a text with this information close to the restaurant's name.
      \end{description}
    \end{minipage}
    \\
    \hline
