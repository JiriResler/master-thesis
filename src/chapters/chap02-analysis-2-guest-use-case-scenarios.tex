...
\todo[inline]{Later - Decide whether to use "A guest" or "The guest" in all descriptions}
\todo[inline]{Later - Change "the application displays a screen with a list" to "the application displays a list" in other reqs}
