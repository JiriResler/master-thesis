...
\todo[inline]{add Save my profile UC - covers req. 1.4}
...
\noindent \textbf{UC2: Specify what allergies I have}
\todo[inline]{add a path where the guest is not authenticated and specifies their allergies when viewing a menu}
Covers req. 1.1, 1.16
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
...
\todo[inline]{add a path where the guest is not authenticated and specifies their diets when viewing a menu}
Covers req. 1.2, 1.16
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
