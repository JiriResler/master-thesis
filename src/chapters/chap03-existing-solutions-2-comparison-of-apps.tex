...
\todo[inline]{After exams - vertically center contents of the table - may be usable for all tables in the thesis} % https://tex.stackexchange.com/questions/7208/how-to-vertically-center-the-text-of-the-cells/611601#611601
\todo[inline]{After exams - make all columns have equal width}
% Guest use cases
\begin{center}
