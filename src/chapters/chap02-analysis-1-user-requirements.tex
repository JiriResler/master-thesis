...
\begin{description}
    ...
    \item [Req. 2.5:] The application shall enable a restaurant employee to edit a previously created menu.
    \item [Req. 2.6:] The application shall enable a restaurant employee to delete a previously created menu.
    \item [Req. 2.7:] A restaurant employee should be able to set a daily menu to repeat periodically for a certain day of the week.

    \emph{Rationale:} A daily menu can be the same for a certain day of the week.
    \item [Req. 2.8:] A restaurant employee should be able to specify categories and subcategories of a menu.
    ...
    \item [Req. 2.9:] If a menu consists of categories then each menu item should be in exactly one category.
    \item [Req. 2.10:] A category in a menu should not be empty.   
    ...
    \item [Req. 2.13:] A menu should optionally contain a restaurant's name, address, telephone number and opening hours.
    ...
    \item [Req. 2.16:] A restaurant employee should be able to specify what weight units to use in a menu.
    \item [Req. 2.17:] A restaurant employee should be able to specify what volume units to use for liquid items in a menu.
    \item [Req. 2.18:] The application should provide an example of a menu.
    ...
    \item [Req. 2.22:] A restaurant employee should be able to set what currency, weight and volume units to use as default when creating a new menu.
    ...
    \item [Req. 2.23:] A restaurant employee should be able to share a menu through the restaurant's Facebook, Twitter and Instagram accounts.
  \end{description}
...
\begin{description}
    ...
    \item [Req. 3.7:] A user of the application shall be able to specify where should the application store their data.
