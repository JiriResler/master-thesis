...
\todo[inline]{Remove all design requirements}
...
\begin{description}
    ...
    highlight items which they cannot eat and also highlight allergen or diet
    \item [Req. 1.5:] The application shall be able to sort meals in a menu by whether a guest can eat them.
    \item [Req. 1.6:] The application shall be able to hide meals of a menu which a guest cannot eat.
    \item [Req. 1.7:] A guest should be able to view a restaurant's menu by specifying the menu's IRI.
    \item [Req. 1.8:] A guest shall be able to view a menu by scanning a QR code on a printed menu.
    ...
    \emph{Rationale:} in addition to their profile
...
\begin{description}
   ...
   \todo[inline]{shrink reqs 3. and 3.8 into one req}
