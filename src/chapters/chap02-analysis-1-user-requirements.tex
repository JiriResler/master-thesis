...
\begin{description}
    ...
    \item [Req. 2.10:] Each item of a menu should belong to either none or exactly one category or subcategory.
    ...
    \item [Req. 2.13:] A menu should optionally contain a restaurant's name, address and telephone number.
    ...
    \item [Req. 2.18:] A restaurant employee should be able to specify what font to use in a menu.
    \item [Req. 2.19:] The application should offer at least three empty menus as templates for a restaurant employee to choose from when creating a menu.
    ...
    \item [Req. 2.20:] A restaurant employee should be able to set that a menu shall use allergen labels for displaying allergen information.

    \emph{Rationale:} Allergens can be listed within an item's description.
    \item [Req. 2.21:] A restaurant employee should be able to set that a menu shall use numbers for displaying allergen information.
