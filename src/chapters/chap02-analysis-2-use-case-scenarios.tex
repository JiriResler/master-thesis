  ...
  \begin{tabular}{| l | p{10.75cm} | }
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        \item The guest navigates to their profile and selects a tab labeled as "My allergies".
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{description}[nosep,after=\strut]
        ...
        \item [A3:] The allergy the guest has specified is already contained in the guest's profile. The application informs the guest about this fact and the guest's profile is not altered.
      \end{description}
    \end{minipage}
    \\
    \hline
...
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        \item The guest navigates to their profile and selects a tab labeled as "My diets".
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{description}[nosep,after=\strut]
        ...
        \item [A3:] The diet the guest has specified is already contained in the guest's profile. The application informs the guest about this fact and the guest's profile is not altered.
      \end{description}
    \end{minipage}
    \\
    \hline
...
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    ...
    Actor    & Guest \\
    \hline
    Description & A guest has two sets of foods stored on their Solid pod which resemble what foods they like and dislike. The scenario describes how the guest can add food items to these sets and also how the application displays them. \\
    \hline
    Scenario &
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        ...
        \item The guest follows a link which says "My food preferences".
        ...
        \item The application provides a search bar with a placeholder text saying "Food name".
        ...
        \item The application adds the specified food to the guest's set of foods which they like and also to the corresponding list on the screen. \textbf{A4}
        \item The guest repeats steps x to y until they have specified all of their food preferences.
      \end{enumerate}
    \end{minipage}
    \\
    \hline
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{description}[nosep,after=\strut]
        \item [A1:] Either one or both of the lists are empty because the guest has not specified any of their preferrences yet. Instead of displaying a list, the application displays a text saying "No food specified".
        \item [A2:] The guest presses a button labeled as "Add food" at the end of the list of foods which they dislike. The scenario continues with a difference that in the step number x the application adds the food to the guest's set of foods which they \emph{dislike}.
        \item [A3:] The application does not recognize the food which the guest is trying to add. The guest creates a public issue in the application's repository with a request to add the desired food to the application.
        \item [A4:] The set and the list already contain the food. The guest is informed about this fact and the set and its corresponding list on the screen are not altered.
      \end{description}
    \end{minipage}
    \\
    \hline
