  ...
  \begin{tabular}{| l | p{10.75cm} | }
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        ...
        \todo[inline]{Extension point}
        \item The restaurant employee specifies how the menu shall display allergen information. (Extension point) 
...
The application inserts allergens when the employee creates a menu item
Employee adjusts them
...
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        \item A restaurant employee creates a new menu as in use case x.
        \item The application automatically inserts allergens based on contents of a menu item.
        \item The application displays allergens in a menu. A1 uses them for personalizing the menu
