...
% \todo[inline]{After exams - check if covered reqs are actually covered by use cases}
% \todo[inline]{After exams - check if order of left column is the same in all use cases}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\linewidth]{master-thesis/img/use-cases/use_cases_restaurant_publish_menu}
  \caption{Restaurant offer use cases}
\end{figure}

\noindent \textbf{UC9: Share a menu on social media}
\begin{center}
...
\noindent \textbf{UC10: Use case: Print a QR code for a menu}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.65\linewidth]{master-thesis/img/use-cases/use_cases_restaurant_manage_menus}
  \caption{Restaurant menu management use cases}
\end{figure}

\newpage

\noindent \textbf{UC11: Use case: Change an ingredient of a meal in an existing menu}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\noindent \textbf{UC12: Deactivate a menu}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\noindent \textbf{UC13: Delete a menu}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\linewidth]{master-thesis/img/use-cases/use_cases_restaurant_create_menu}
  \caption{Restaurant menu creation use cases}
\end{figure}

\newpage

\noindent \textbf{UC14: Create a new menu}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor         & Restaurant \\
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        ...
        \item The restaurant employee specifies when will the menu be valid. \textbf{Extension point for UC17-UC21}
...
\noindent \textbf{UC15: Add a food item to a menu} 
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor         & Restaurant \\
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{enumerate}[leftmargin=*,nosep,before=\vspace{-0.575\baselineskip},after=\strut]
        ...
        \item The application adds allergens to the menu item. \textbf{Extension point for UC16}
...
\noindent \textbf{UC16: Warn my guests about allergens in the foods I serve}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor         & Restaurant \\
...
\noindent \textbf{UC17: Create a stable menu}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\noindent \textbf{UC18: Create a list of beverages}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\linewidth]{master-thesis/img/use-cases/use_cases_restaurant_create_daily_menu}
  \caption{Restaurant daily menu creation use cases}
\end{figure}

\noindent \textbf{UC19: Create a daily menu for tomorrow}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\noindent \textbf{UC20: Create daily menus for the next week}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\noindent \textbf{UC21: Create a daily menu which will repeat each Tuesday}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
...
\noindent \textbf{UC22: Have control over my data}
\begin{center}
  \begin{tabular}{| l | p{10.75cm} | }
    \hline
    Actor        & Restaurant \\
