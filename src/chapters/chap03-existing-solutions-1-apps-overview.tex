...
\todo[inline]{write that there are figures - screenshots for each app}
Now we will briefly introduce currently available applications.

\todo[inline]{add link in footnote}
\subsection*{Allergy Menu}
  Allergy menu allows a restaurant employee to maintain a mobile accessible and up-to-date menus that customers can tailor to their food preferences.
