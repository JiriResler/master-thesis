...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.62\linewidth]{master-thesis/img/application_use_cases_guest_manage_profile}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.62\linewidth]{master-thesis/img/application_use_cases_restaurant_manage_menus}
