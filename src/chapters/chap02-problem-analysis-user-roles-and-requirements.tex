...
\begin{description}
    ...
    \item [Req. 2.3:] A restaurant employee should be able to re-use a previously created menu when creating menu for a day.
    ...
    \item [Req. 2.9:] A meal in a menu should contain an ID, label, price, weight in grams, ingredients and allergens.
    \item [Req. 2.10:] A restaurant employee should be able to specify which Solid pod to use for storing the restaurant's data.
